...
export default function Hero() {
    return (
        <section
            id="inicio"
            className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-gradient-to-b from-black via-[#0d1117] to-black text-white"
        >
            <div className="flex space-x-4 mb-6">
                <a
                    href="/cv-sebastian.pdf"
                    download
                    className="flex items-center gap-2 border border-[#94a3b8] text-[#e2e8f0] px-5 py-2 rounded-md text-sm transition duration-300 hover:bg-[#1e293b] hover:border-cyan-500 hover:text-cyan-300"
                >
                    <HiOutlineDocumentArrowDown className="text-sm" />
                    Descargar CV
                </a>
            </div>
            <h1 className="text-3xl md:text-5xl text-[#d1d5db] font-semibold mb-2">Sebastián Murillo</h1>
            <h2 className="text-lg md:text-xl text-[#9ca3af] mb-6" >Desarrollador Fullstack</h2>
            ...
            <div className="flex space-x-4 mb-6">
                <a
                    ...
                    className="text-blue-500 hover:text-cyan-300 text-xl"
                >
                    <FaLinkedin />
                </a>
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-white hover:text-cyan-300 text-xl"
                >
                    <FaGithub />
                </a>
            </div>
